...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-dot-pattern relative">
      ...
      {/* 1. BAKGRUND: FÄRGBOLLAR (Längst bak) */}
      ...
      {/* 2. BAKGRUND: STOR STJÄRN-SVG (Mellanlagret) 
          pointer-events-none gör att man klickar *igenom* bilden (så man kan klicka på knapparna på sidan).
          opacity-30 gör den lite blekare så den inte stör texten i korten.
      */}
      <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-0 opacity-40">
        ...
        >
          {/* Omloppsbanor som representerar nätverket */}
      ...
      {/* 3. INNEHÅLLET (relative z-10 gör att detta ligger överst) */}
